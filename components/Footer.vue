<template>
    <div>
        <section class="py-10 bg-gradient-to-r from-slate-800 to-stone-600 sm:pt-16 lg:pt-24">
            <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-y-12 gap-x-8 xl:gap-x-12">
                    <div class="col-span-2 md:col-span-4 xl:pr-8">
                        <img class="w-auto h-9" src="~/assets/logo.png" alt="" />
                    </div>
                </div>

                <div class="sm:flex sm:items-center sm:justify-between">
                    <p class="text-sm text-gray-300">
                        © Copyright 2021, All Rights Reserved by Technoroi
                    </p>
